import 'package:energi_kolaborasi/models/categorie_model.dart';
...
List<CategoryModel> getCategories(){
  ...
  categoryModel.categoryName = "Mineral";
  ...
  //2
  categoryModel = new CategoryModel();
  categoryModel.categoryName = "Energi";
  ...
  //3
  categoryModel = new CategoryModel();
  categoryModel.categoryName = "Tambang";
  ...
  //4
  categoryModel = new CategoryModel();
  categoryModel.categoryName = "Minyak";
  ...
  //5
  categoryModel = new CategoryModel();
  categoryModel.categoryName = "Sains";
